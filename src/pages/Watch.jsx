    ...
    <div className="container mx-auto p-6">
      {loading ? (
        ...
        <div className="text-center p-10">
          <h2 className="text-2xl font-bold text-gray-700">Transmissão não encontrada</h2>
          <p className="mt-2 text-gray-500">A transmissão solicitada não existe ou foi removida.</p>
          <Button 
